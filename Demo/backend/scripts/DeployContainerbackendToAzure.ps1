...
$backendappContainerName = "az204DemoBackendApp123"
...
az resource update --ids /subscriptions/$AzureSubscriptionId/resourceGroups/$resourceGroupName/providers/Microsoft.Web/sites/$backendappContainerName/config/web --set properties.acrUseManagedIdentityCreds=True
